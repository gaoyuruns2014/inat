...
<form class="form-horizontal">
    <fieldset>
        ...
        <!-- Text input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="admin">联系人：</label>  
            <div class="col-md-5">
                <input id="admin" name="admin" placeholder="" class="form-control input-md" required="" type="text">
        ...
        <!-- Text input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="mobile">手机：</label>  
            <div class="col-md-4">
        ...
        <!-- Text input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="povince">省份：</label>  
            <div class="col-md-4">
                <input id="povince" name="povince" placeholder="" class="form-control input-md" type="text">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="logo" name="logo" placeholder="" class="form-control input-md" type="text">
        ...
        <!-- Text input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="active">活跃状态：</label>  
            <div class="col-md-4">
                <input id="active" name="active" placeholder="" class="form-control input-md" type="text">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <a href="index.php?r=manufacturer/index"><button id="" name="" class="btn btn-primary">添加制造商</button></a>
            </div>
        </div>
